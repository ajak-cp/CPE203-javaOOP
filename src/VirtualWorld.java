   ...
   */
   public void setup()
   {
      ...
      this.world = new WorldModel(WORLD_ROWS, WORLD_COLS,
         Functions.createDefaultBackground(imageStore));
   ...
   {
       AnimatedActorVisitor actorVisitor = new AnimatedActorVisitor();
      for (Entity entity : world.getEntities())
      {
         if(entity.accept(actorVisitor)) {
            ((ScheduleActivity)entity).scheduleActions(entity, world, scheduler, imageStore);
         }
      }
   }
   ...
   public void keyPressed()
   {
    ...
    public void mousePressed(processing.event.MouseEvent e){
      ...
      int y = e.getY()/TILE_HEIGHT;
        view.drawRainbow(x,y,imageStore);
    }
      ...
      ImageStore imageStore)
   {
      try
      {
         ...
         Functions.load(in, imageStore, world);
      }
